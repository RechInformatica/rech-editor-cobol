...
/**
 * A class representing an "IF" node in the COBOL flow analysis tree.
 */
export class IfNode implements NodeInterface {
    ...
    /**
     * Retrieves the child nodes of this "IF" node.
    ...
    /**
     * Retrieves the row number of this "IF" node in the COBOL source code.
