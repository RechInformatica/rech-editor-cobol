...
/**
 * A class representing a "Perform Loop" node in the COBOL flow analysis tree.
 */
export class PerformLoopNode implements NodeInterface {
    ...
    /**
     * Retrieves the child nodes of this "Perform Loop" node.
